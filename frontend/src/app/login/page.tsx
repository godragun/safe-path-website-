    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0e1a] p-4">
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold text-slate-100 mb-2">Command Center Login</h1>
          <p className="text-slate-400 text-sm mb-8">Access the SafePath Disaster Response platform</p>
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-400 mb-1">PASSCODE</label>
              <input 
                type="password" 
                required
                value={password}
